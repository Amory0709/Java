...
public class Filters {
	...
	public static Color brighter(Color c) {
		Color brighterC = c.brighter();
		return brighterC;  // FIXME
	}
	...
	public static Color grayscale(Color c) {
		...
		Color greyscale = new Color (newColor,newColor,newColor);
		return greyscale;  // FIXME
	}
	...
	public static Color bgSubtract(Color source1Color, Color source2Color, int tolerance) {
		...
		if(Math.abs(red1 - red2)<= tolerance && Math.abs(green1 - green2)<=tolerance && Math.abs(blue1 - blue2)<=tolerance){
			return Color.blue; 
		}	
		else {
			return source1Color;
